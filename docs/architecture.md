...
|---|---|---|
| `src/levels.ts` | Pure data — 19 levels as ASCII maps (+ optional sky layers), terminal definitions, bush contents, keycaps, linters, budgets, reference solutions, enemy leash options. | `engine/types` |
