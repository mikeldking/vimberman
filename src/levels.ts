...
export const LEVELS: LevelDef[] = [
  ...
  },
  {
    ...
    intro: [
      ...
      'Ctrl-d drops you back anywhere the ground is clear.',
      'The zombies will gather under your shadow. Let them.',
    ],
    map: [
      '###############',
      '#P?..@...Z...*#',
    ...
    keycaps: { '2,1': 'sky' },
    hint: 'the ground route is a zombie gauntlet. the sky route is two chords.',
    solution: 'l 3l <C-u> 6j 3h <C-d> h',
    par: 10, limit: 26,
  },
  {
    name: 'BOOKMARKED',
