...
// `test/solve.test.ts` plays them; `test/level-design.test.ts` uses the same
// manifest to keep docs/level-design.md route counts honest.
export const ROUTES: Record<number, Record<string, string>> = {
  2: {
